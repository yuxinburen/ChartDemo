 ...
 * @date 2015-11-11 17:21
 * @package com.chartdemo.ui.markview
 * @description MarkView  TODO(界面功能描述)
...
public class MarkView extends View {
    ...
    private static final int MODE_TYPE_SMALL = 1;
    ...
    private static final int ITEM_SMALL_HEIGHT = 10;
...
//        int colors[] = { 0xFF999999, 0xFFFFFFFF, 0xFF999999 };// 分别为开始颜色，中间夜色，结束颜色
    ...
    private void drawWheel(Canvas canvas) {
        Drawable wheel = getResources().getDrawable(R.drawable.wheel_val);
        ...
        for (int i = 0; drawCount <= 4 * width; i++) {
            ...
            if (xPosition + getPaddingRight() < mWidth) {
                if ((mValue + i) % mModType == 0) {
                    canvas.drawLine(xPosition, getPaddingTop(), xPosition, mDensity * ITEM_MAX_HEIGHT * 2 / 3 , linePaint);
                    canvas.drawLine(xPosition, getPaddingTop()+getHeight(), xPosition, getPaddingTop()+getHeight() - mDensity * ITEM_MAX_HEIGHT * 2 / 3, linePaint);
...
//                                canvas.drawText(String.valueOf((mValue + i) / 2), countLeftStart(mValue + i, xPosition, textWidth), getHeight() - textWidth, textPaint);
                                canvas.drawText(String.valueOf((mValue + i) / 2), countLeftStart(mValue + i, xPosition, textWidth), getHeight()/2 + textWidth * 2/3, textPaint);
                                break;
                            case MOD_TYPE_ONE:
                    ...
                    canvas.drawLine(xPosition, getPaddingTop(), xPosition, mDensity * ITEM_MIN_HEIGHT * 2 / 3, linePaint);
                    canvas.drawLine(xPosition, getPaddingTop()+getHeight(), xPosition, getPaddingTop()+getHeight() - mDensity * ITEM_MIN_HEIGHT * 2 / 3, linePaint);
                }
            }
...
//                                canvas.drawText(String.valueOf((mValue - i) / 2), countLeftStart(mValue - i, xPosition, textWidth), getHeight() - textWidth, textPaint);
                            ...
                            case MOD_TYPE_ONE:
//                                canvas.drawText(String.valueOf(mValue - i), xPosition - (textWidth * numSize / 2), getHeight() - textWidth, textPaint);
                                canvas.drawText(String.valueOf(mValue - i), xPosition - (textWidth * numSize / 2), getHeight(), textPaint);
                                break;
                            default:
                                break;
                        }
    ...
    private void drawMiddleLine(Canvas canvas) {
        ...
        int gap = 12, indexWidth = 2, indexTitleWidth = 12, indexTitleHight = 2, shadow = 1;
