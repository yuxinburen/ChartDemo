...
public class MultiLineActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayLineViews[0] = ((LineChartView) findViewById(R.id.lineChartView1));
        arrayLineViews[1] = ((LineChartView) findViewById(R.id.lineChartView2));
        arrayLineViews[2] = ((LineChartView) findViewById(R.id.lineChartView3));
        arrayLineViews[3] = ((LineChartView) findViewById(R.id.lineChartView4));
        arrayLineViews[4] = ((LineChartView) findViewById(R.id.lineChartView5));

        getData(36, 100);

        for (int i = 0; i < 5; i++) {
            arrayLineViews[i].setViewType(LineChartView.SHOW_TYPE.DEFAULT);
            ...
            arrayLineViews[i].setupChart(null, null);
        }
    }
